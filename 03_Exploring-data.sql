...
SELECT 
 ...
 -- 6. (OPTIONAL) Counts the records that are NULL for both start_station and end_station. This was used to compare how many registers would be affected if deleting all null values: 417110.
SELECT COUNT(*)
FROM `2023_combined`
